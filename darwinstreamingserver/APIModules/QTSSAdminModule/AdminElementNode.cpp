...
{   // key, API_ID,     fIndex,     Name,       Name_Len,       fAccessPermissions, Access, access_Len, fAPI_Type, fFieldType ,fAPISource
    {0,     0,          0,          "admin",    (UInt32)strlen("admin"),    qtssAttrModeRead, "r", (UInt32)strlen("r"),0,   ElementNode::eNode, NULL    }
};

ElementNode::ElementDataFields AdminClass::sAdminFieldIDs[] = 
{   // key, API_ID,     fIndex,     Name,       Name_Len,       fAccessPermissions, Access, access_Len, fAPI_Type, fFieldType ,fAPISource
    {0,     0,          0,          "server",   (UInt32)strlen("server"),qtssAttrModeRead,  "r", (UInt32)strlen("r"),qtssAttrDataTypeQTSS_Object,   ElementNode::eNode, NULL    }
};
